        ...
        <ul class="toolbar">
            <shiro:hasPermission name="prjAdd">
                <li id="prjAdd"><span><img
                        src="/resources/core/images/t01.png"/></span>添加项目
                </li>
            </shiro:hasPermission>
            <shiro:hasPermission name="prjEdit">
                <li id="prjEdit"><span><img
                        src="/resources/core/images/t02.png"/></span>修改项目
                </li>
            </shiro:hasPermission>
            <shiro:hasPermission name="prjDel">
                <li id="prjDel"><span><img
                        src="/resources/core/images/t03.png"/></span>删除项目
                </li>
            </shiro:hasPermission>
            <shiro:hasPermission name="prjRole">
                <li id="prjRole"><span><img
                        src="/resources/core/images/save.png"/></span>授予角色
                </li>
            </shiro:hasPermission>
            <shiro:hasPermission name="prjUser">
                <li id="prjUser"><span><img
                        src="/resources/core/images/save.png"/></span>分配用户
                </li>
            </shiro:hasPermission>
        </ul>
    </div>
