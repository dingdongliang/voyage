...
<script type="text/javascript">
    $(function () {
        ...
        $("#form").form({
            url: "manage/project/saveOrUpdatePrj",
            onSubmit: function () {
                $.messager.progress({
                    title: '提示',
                    text: '数据处理中，请稍后....'
...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 10px;">
        <form id="form" method="post">
            <fieldset>
                <legend><img src="resources/core/images/fromedit.png" style="margin-bottom: -3px;"/> 项目组编辑
                </legend>
                ...
                <table>
                    <tr>
                        <th>项目组名称</th>
                        <td><input name="prjName" id="prjName" placeholder="请输入项目组名称"
                    ...
                    <tr>
                        <th>项目等级</th>
                        <td><input name="level" id="level" type="text" class="easyui-textbox easyui-validatebox"/>
                        </td>
                        <th>所属公司</th>
                    ...
                    <tr>
                        <th>项目描述</th>
                        <td colspan="3"><textarea class="easyui-textbox" name="prjDesc"
