        ...
        <form id="form" method="post">
            <fieldset>
                ...
                <table>
                    <tr>
                        <th>日志名称</th>
                        <td><input name="name" id="name" placeholder="请输入日志名称" class="easyui-textbox easyui-validatebox"
                                   type="text"/></td>
                        <th>日志类型</th>
                        <td><select id="type" class="easyui-combobox" name="type" style="width:171px;"
                    ...
                    <tr>
                        <th>操作名称</th>
                        <td><input name="eventName" id="eventName" type="text" class="easyui-textbox easyui-validatebox"
                    ...
                    <tr>
                        <th>操作描述</th>
                        <td colspan="3"><textarea class="easyui-textbox" name="eventRecord"
