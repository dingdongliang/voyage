...
public interface RolePmsnMapper extends BaseMapper<RolePmsn> {
     ...
     * param:[roleId]
     * return:java.util.List<com.dyenigma.entity.RolePmsn>
     */
    List<RolePmsn> findAllByRoleId(String roleId);
